...
Метод getIntMinutes(): Так как при работе со временем удобней использовать не символы, а числовые значения, то я решил создать отдельный метод, который будет возвращать количество минут в типи данных int.
```java
